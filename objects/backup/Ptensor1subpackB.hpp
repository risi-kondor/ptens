...
#include "Cgraph.hpp"
#include "Ptensor_subpack.hpp"

namespace ptens{


  class Ptensor1subpack: public Ptensor_subpack{ //cnine::RtensorA{
  public:
    ...
    Ptensor1subpack(const int _k, const int _nc, const int _dev=0): 
      Ptensor_subpack({0,_k,_nc},cnine::fill_raw(),_dev),
      //rtensor({0,_k,_nc},cnine::fill_raw(),_dev),
      atoms(_k,_dev){}


    Ptensor1subpack(const PtensorSgntr& sgntr, const int _dev=0):
      Ptensor_subpack({0,sgntr.k,sgntr.nc},cnine::fill_raw(),_dev),
    ...
    Ptensor1subpack(const AtomsPack& _atoms, const int nc, const FILLTYPE& dummy, const int _dev=0):
      Ptensor_subpack(cnine::Gdims(_atoms.getn(),_atoms.getk(),nc),dummy,_dev),
