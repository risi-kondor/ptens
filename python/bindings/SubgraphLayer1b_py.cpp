...
pybind11::class_<SGlayer1b,Ptensors1b<float> >(m,"subgraph_layer1b")
...
//    return SGlayer1b(G,_nc,fcode,_dev);}, 
...
// ---- Message passing --------------------------------------------------------------------------------------
  ...
  .def("gather",[](const SGlayer0b& x, const Subgraph& a){return SGlayer1b(x,a);})
  .def("gather",[](const SGlayer1b& x, const Subgraph& a){return SGlayer1b(x,a);})
  .def("gather",[](const SGlayer2b& x, const Subgraph& a){return SGlayer1b(x,a);});
