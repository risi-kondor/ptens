...
// ---- Message passing --------------------------------------------------------------------------------------
  ...
  .def("gather",[](const SGlayer0b& x, const Subgraph& a){return gather1(x,a);})
  .def("gather",[](const SGlayer1b& x, const Subgraph& a){return gather1(x,a);})
  .def("gather",[](const SGlayer2b& x, const Subgraph& a){return gather1(x,a);});
