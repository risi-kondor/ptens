...
pybind11::class_<Ptensors2b<float> >(m,"ptensors2b")
  ...
  .def("zeros_like",[](const Ptensors2b<float>& x){return Ptensors2b<float>::zeros_like(x);})
  .def("randn_like",[](const Ptensors2b<float>& x){return Ptensors2b<float>::gaussian_like(x);})
...
//.def("add_to_grad",[](Ptensors2b<float>& x, const Ptensors2b<float>& y, const float c){x.add_to_grad(y,c);})
  .def("add_to_grad",[](Ptensors2b<float>& x, at::Tensor& y){x.get_grad().add(ATview<float>(y));})
  .def("add_to_grad",[](Ptensors2b<float>& x, const Ptensors2b<float>& y, const float c){x.get_grad().add(y,c);})
...
// ---- Operations -------------------------------------------------------------------------------------------
  ...
  .def("cat_channels_back0",[](Ptensors2b<float>& x, const Ptensors2b<float>& r){return x.cat_channels_back0(r);})
  .def("cat_channels_back1",[](Ptensors2b<float>& x, const Ptensors2b<float>& r){return x.cat_channels_back1(r);})
...
//.def("outer_back1",&Ptensors2b::outer_back1)
  ...
  .def("ReLU",[](const Ptensors2b<float>& x, const float alpha){
      return ReLU(x,alpha);})
  .def("add_ReLU_back",[](Ptensors2b<float>& x, const Ptensors2b<float>& g, const float alpha){
...
// ---- Message passing --------------------------------------------------------------------------------------
  ...
  .def_static("linmaps",[](const Ptensors0b<float>& x){
      return Ptensors2b<float>::linmaps(x);}) 
