...
//	return BPtensors0(AtomsPack(atoms),Ltensor<float>(TVIEW(M)));}))
...
//      return BPtensors0(AtomsPack(_atoms),_nc,fcode,_dev);}, 
//    py::arg("atoms"),py::arg("nc"),py::arg("fcode")=0,py::arg("device")=0)
...
//  .def("like",[](const BPtensors0<float>& x, at::Tensor& M){
...
//  .def("cat_channels",[](const BPtensors0& x, const BPtensors0& y){return cat_channels(x,y);})
//  .def("cat_channels_back0",&BPtensors0::cat_channels_back0)
//  .def("cat_channels_back1",&BPtensors0::cat_channels_back1)
