...
class subgraphlayer0b(torch.Tensor):
    ...
    @classmethod
    def like(self,x,M):
        return Subgraphlayer0b_likeFn.apply(x,M)
    ...
    @classmethod
    def linmaps(self,x):
        return Subgraphlayer0b_LinmapsFn.apply(x)
    ...
    def gather_from_ptensors(self,x,G,S):
        return Subgraphlayer0b_GatherFromPtensorsbFn.apply(x,G,S)
...
class Subgraphlayer0b_likeFn(torch.autograd.Function):

    @staticmethod
    def forward(ctx,x,M):
        r=subgraphlayer0b(1)
        r.obj=_subgraphlayer0b.like(x.obj,M)
        ctx.r=r.obj
        return r

    @staticmethod
    def backward(ctx,g):
        return subgraphlayer0b.dummy(), ctx.r.get_grad().torch(), None
...
class Subgraphlayer0b_LinmapsFn(torch.autograd.Function):

    @staticmethod
    def forward(ctx,x):
        r=subgraphlayer0b.dummy()
        r.obj=_subgraphlayer0b.linmaps(x.obj) 
        ctx.x=x.obj
        ctx.r=r.obj
        return r
...
class Subgraphlayer0b_GatherFromPtensorsbFn(torch.autograd.Function):

    @staticmethod
    def forward(ctx,x,G,S):
        r=subgraphlayer0b.dummy()
        r.obj=_subgraphlayer0b(x.obj,G.obj,S.obj)
        ctx.x=x.obj
        ctx.r=r.obj
        return r
