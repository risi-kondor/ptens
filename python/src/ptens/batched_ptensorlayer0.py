...
class batched_ptensorlayer0(p.batched_ptensorlayer):
    ...
    def gather(self,atoms,x,*args):
        ...
        if len(args)==0:
            return batched_ptensorlayer0.gather(atoms,x,pb.batched_ptensor_map.overlaps_map(atoms,x.atoms)) 
        else:
    ...
    def __repr__(self):
        return "batched_ptensorlayer0(len="+str(len(self))+",nc="+str(self.size(1))+")"
