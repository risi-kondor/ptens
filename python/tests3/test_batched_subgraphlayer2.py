...
print("\n-------------------------------------")
print (" batched_subgraphlayer2")
print("-------------------------------------\n")

print("A batched_subgraphlayer2 is a batch of subgraphlayer2 objects.\n")
...
print("We can then define a random batched second order subgraph layer:\n")
A=p.batched_subgraphlayer0.randn(G,S,3)
print(A)

print("Or define it from a torch tensor:\n")
M=torch.randn([G.subgraphs(S).nrows0(),3])
A=p.batched_subgraphlayer0.from_matrix(G,S,M)
print(A)

print("If two batched subgraphlayers have the same reference domains,\nwe can do arithmetic on them:\n")
B=p.batched_subgraphlayer0.randn(G,S,3)
print(A+A)
...
A=p.batched_subgraphlayer0.from_matrix(G,S,M)
B=p.batched_subgraphlayer0.linmaps(A)
print(B)
