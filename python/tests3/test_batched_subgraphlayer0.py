...
print("\n-------------------------------------")
print (" batched_subgraphlayer0")
print("-------------------------------------\n")

print("A batched_subgraphlayer0 is a batch of subgraphlayer0 objects.\n")
...
print("We can then define a random batched subgraph layer:\n")
