...
#B0=p.csubgraphlayer1.gather(S,A0)
#print(B0)

print("Gather from a 1st order subgraph layer:\n")
A1=p.csubgraphlayer1.randn(G,S,3,3)
B1=p.csubgraphlayer1.gather(S,A1)
print(B1)


print("Gather from a 2nd order subgraph layer:\n")
A2=p.csubgraphlayer2.randn(G,S,nvecs,3)
B2=p.csubgraphlayer1.gather(S,A2)
print(B2)
