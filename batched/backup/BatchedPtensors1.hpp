...
namespace ptens{
  ...
  public: // ----- Constructors ------------------------------------------------------------------------------
    ...
    BatchedPtensors1(const BatchedAtomsPack& _atoms, const cnine::Ltensor<float>& M):
    ...
    BatchedPtensors1(const BatchedAtomsPack1& _atoms, const TENSOR& M):
      BASE(M.copy(ptens_session->managed_gmem)), atoms(_atoms){}

    BatchedPtensors1(const BatchedAtomsPack1& _atoms, const int _nc, const int fcode, const int _dev):
      BASE({_atoms.tsize(),_nc},fcode,_dev), atoms(_atoms){}


    BatchedPtensors1(const BatchedAtomsPack1& _atoms, const int _nc, const int _dev):
      BatchedPtensors1(_atoms,_nc,0,_dev){}

    BatchedPtensors1(const BatchedAtomsPack& _atoms, const int _nc, const int _dev):
      BatchedPtensors1(BatchedAtomsPack1(_atoms),_nc,0,_dev){}
    ...
    BatchedPtensors1(TYPE* _arr, const BatchedAtomsPack1& _atoms, const int _nc, const int _dev):
    ...
    BatchedPtensors1(TYPE* _arr, const BatchedAtomsPack& _atoms, const int _nc, const int _dev):
      BatchedPtensors1(_arr,BatchedAtomsPack1(_atoms),_nc,_dev){}
    ...
    static BatchedPtensors1 cat(const vector<BatchedPtensors1>& list){
      ...
      for(auto& p:list)
	v.push_back(p.atoms);
      BatchedPtensors1 R(BatchedAtomsPack1::cat(v),list[0].get_nc(),list[0].get_dev());
  ...
  public: // ----- Access ------------------------------------------------------------------------------------
    ...
    Ptensors1<TYPE> view_of(const int i) const{
      return Ptensors1<TYPE>(TENSOR::rows(atoms.offset(i),atoms.nrows(i)),atoms.obj->obj[i]);
    }
    ...
    Ptensors1<TYPE> operator[](const int i) const{
      return Ptensors1<TYPE>(AtomsPack1(atoms.obj->obj[i]),TENSOR::rows(atoms.offset(i),atoms.nrows(i)));
    }
  ...
  public: // ---- Message passing ----------------------------------------------------------------------------
    ...
    static BatchedPtensors1<TYPE> linmaps(const SOURCE& x){
      BatchedPtensors1<TYPE> R(x.get_atoms(),x.get_nc()*vector<int>({1,2,5})[x.getk()],x.get_dev());
      R.add_linmaps(x);
      return R;
    }
