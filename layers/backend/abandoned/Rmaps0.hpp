...
#ifndef _ptens_Rmaps0
#define _ptens_Rmaps0
...
namespace ptens{
  ...
  class Rmaps0: public cnine::observable<Rmaps0<OWNER> >{
  public:

    typedef cnine::ptr_pair_indexed_object_bank<MessageListObj,Rmaps0,MessageMap> MMBank;
